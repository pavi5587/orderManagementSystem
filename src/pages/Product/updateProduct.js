...
const UpdateProduct = () => {
    ...
    GetProductDetailById(productId)
      .then((res) => {
        ...
        setFormData({
          ...
          costPerItem: res.data.costPerItem,
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await UpdateProductDetail(productId,formData);
      Toaster("success", "ProductDetail Updated Sucessfully", 5000);
    } catch (error) {
      Toaster("error", "ProductDetail Not Updated", 5000);
    }
  };
  return (
    <div>
                  ...
                  <div class="custom-select-wrapper">
                    ...
                    >
                      ...
                      {companyDetail.map((res) => {
                        return (
                          <option value={res._id}>{res.companyName}</option>
                        );
                      })}
                    </select>
                    <i class="fas fa-caret-down custom-select-arrow"></i>
